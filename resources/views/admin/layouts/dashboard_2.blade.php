...
<html lang="en">
   <head>
      ...
      <!-- color css -->
      <link rel="stylesheet" href="admin/css/color_2.css" />
      <!-- select bootstrap -->
   ...
   <body class="dashboard dashboard_2">
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="index.html"><img class="img-responsive" src="admin/images/logo/logo_black.png" alt="#" /></a>
                        </div>
                                          ...
                                          <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                                             ...
                                             <div class="carousel-inner">
                                                <div class="item carousel-item active">
                                                   <div class="img-box"><img src="admin/images/layout_img/user_img.jpg" alt=""></div>
      ...
      <script src="admin/js/chart_custom_style2.js"></script>
   </body>
</html>